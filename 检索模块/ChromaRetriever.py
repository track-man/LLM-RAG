...
def diagnose_retriever_issues():
    ...
    try:
        ...
        # 测试集合操作
        try:
            collection = client.get_collection("test_diagnose")
            client.delete_collection("test_diagnose")
        except:
            collection = client.create_collection("test_diagnose")
        print("   ✅ ChromaDB集合操作成功")
